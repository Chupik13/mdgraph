 ...
 * their angular position relative to the centroid of all matching nodes.
 *
 ...
 * all matching nodes sorted by their angular position relative to the centroid
 * (center of mass) of all matching nodes, starting from 12 o'clock (north) and proceeding clockwise.
 *
 ...
 *
 * The center point for angle calculation is the centroid (center of mass)
 * of all matching search result nodes, providing consistent navigation order.
 *
 * ## Navigation Behavior
...
export const useSearchNavigation = () => {
  ...
  /**
   * Gets all search result nodes sorted clockwise by angle from centroid.
   *
   * Retrieves the list of active (matching) nodes from the search, calculates
   * their angular positions relative to the centroid (center of mass) of all
   * matching nodes, and sorts them clockwise starting from 12 o'clock.
   *
   * @returns Array of node IDs sorted by clockwise angle, or empty array if no search results
   *
   * @remarks
   * ## Angle Calculation
   * 1. Calculate centroid (center of mass) of all matching search result nodes
